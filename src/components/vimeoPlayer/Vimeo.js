...
class Vimeo extends React.Component {
  ...
  getInitialOptions() {
    ...
    return {
      ...
      requestPictureInPicture: this.props.requestPictureInPicture,
      pictureInpicture: this.props.pictureInpicture,
    };
    ...
    propNames.forEach((name) => {
      ...
      switch (name) {
        case "requestPictureInPicture":
          player.requestPictureInPicture(value);
          break;
...
if (process.env.NODE_ENV !== "production") {
  Vimeo.propTypes = {
     ...
     * Play the video again when it reaches the end.
     */
    requestPictureInPicture: PropTypes.bool,
